...
export const About = (
  <>
    ...
    <ExternalLink href="mailto:dheeraj@drjvtlkr.com">send me an email.</ExternalLink>
  </>
);
...
export const SocialMedia = [
  { name: 'Twitter', link: 'https://twitter.com/drjvtlkr', icon: FaSquareXTwitter },
  { name: 'Instagram', link: 'https://www.instagram.com/drjvtlkr/', icon: FaInstagram },
  { name: 'Github', link: 'https://github.com/drjvtlkr', icon: FaGithub },
  { name: 'LinkedIn', link: 'https://www.linkedin.com/in/drjvtlkr', icon: FaLinkedin },
] as const;
