...
import { Project } from '@/app/data/lifeApi';
...
export const ProjectCard = ({ project }: Props) => {
  return (
    <Card className="h-full border hover:border p-4 rounded-md" key={project.title}>
      <div className="relative z-10 flex h-16 w-16 p-2 items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <Image
          src={project.logo}
